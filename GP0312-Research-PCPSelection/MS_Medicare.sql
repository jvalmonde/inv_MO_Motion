/*** 
PCP Selection (Medicare population) Master Script
...
select a.SavvyHICN, Provider_MPIN = a.MPIN, Provider_TIN = TIN, EFNCY_FLAG, QLTY_FLAG
	, PCP_Flag	= max(isnull(PCP_Flag,0))	--added 1/11/2017; consolidate data per member, MPIN, TIN combo level as per Matt
	, Specialty = LongDesc
	--spend
