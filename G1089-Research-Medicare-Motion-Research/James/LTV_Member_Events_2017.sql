...
select SavvyHICN, 	   
	   ...
	   HCC, Flag
into #mor_unpivot
from pdb_WalkandWin..CMS_MOR_Subset_20170727 unpivot(Flag for HCC in(
...
-- drop table pdb_WalkandWin..LTV_Member_Events
...
into pdb_WalkandWin..LTV_Member_Events
from(
...
create index ix_y on pdb_WalkandWin..LTV_Member_Events(SavvyHICN, Year_Mo)