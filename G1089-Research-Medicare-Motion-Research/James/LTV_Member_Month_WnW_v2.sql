...
into #med_claims_2
from #members										a					
left join MiniOV..Fact_Claims						c	on	a.SavvyID = c.SavvyID
...
select a.SavvyHICN, a.Lifetime_ID, a.Year_Mo, a.Contr_Nbr, a.PBP,
	   ...
	   a.Top5_Prcnt_2015,
	   a.Top5_Prcnt_2016
into  pdb_WalkandWin..LTV_Member_Month
from #results_2						as a
join pdb_WalkandWin..CPI_Adjustment			as b	on left(a.Year_Mo, 4) = b.Yr
-- 2,400,108


create unique clustered index ix_x on pdb_WalkandWin..LTV_Member_Month(SavvyHICN, Year_Mo)


---- select * from pdb_WalkandWin..LTV_Member_Month

select * from pdb_WalkandWin..LTV_Member_Month where left(Year_Mo,4) = 2015
