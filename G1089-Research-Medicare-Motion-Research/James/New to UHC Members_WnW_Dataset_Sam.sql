...
from #member_List_initial as mli 
LEFT JOIN MiniOV..Dim_MemberDetail as b on mli.MiniOV_SavvyID = b.SavvyID
LEFT JOIN MiniOV..Dim_Source_System_Combo as c on b.Src_Sys_Cd = c.SRC_SYS_CD
where 1 = 1
	and mli.SavvyHicn is not null										--only get those with SavvyHICNs
...
into pdb_WalkandWin..New_Member_Information_2016_Pilot
...
create unique index uix on  pdb_WalkandWin..New_Member_Information_2016_Pilot(savvyhicn)