...
into #members
from pdb_WalkandWin..WnW_Dataset_Sam					as a
...
from(
	...
	from(
		...
		from pdb_WalkandWin..WnW_Dataset_Sam_MMR	as a
...
create table pdb_WalkandWin..LTV_Member_Month_2016_Pilot(
...
insert into pdb_WalkandWin..LTV_Member_Month_2016_Pilot
select a.SavvyHICN, a.Lifetime_ID, a.Year_Mo, a.Contr_Nbr, a.PBP,
...
create unique index ix_x on pdb_WalkandWin..LTV_Member_Month_2016_Pilot(SavvyHICN, Year_Mo)
