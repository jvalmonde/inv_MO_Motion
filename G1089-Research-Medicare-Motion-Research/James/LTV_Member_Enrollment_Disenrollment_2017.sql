...
from(
	...
	from pdb_WalkandWin..CMS_TRR_Subset_20170727				as a 
...
left join(
	...
	from pdb_WalkandWin..CMS_TRR_Subset_20170727
...
into pdb_WalkandWin..LTV_Member_Enrollment
from pdb_WalkandWin..LTV_Member_Lifetime_ID			as a 
join pdb_WalkandWin..LTV_Member_Month					as x	on a.SavvyHICN = x.SavvyHICN and a.Enroll_Year_Mo = x.Year_Mo
...
create unique index ix_x on pdb_WalkandWin..LTV_Member_Enrollment(SavvyHICN, Lifetime_ID)
create unique index ix_y on pdb_WalkandWin..LTV_Member_Enrollment(SavvyHICN, Enroll_Year_Mo)

-- drop table pdb_WalkandWin..LTV_Member_Disenrollment
...
into pdb_WalkandWin..LTV_Member_Disenrollment
from pdb_WalkandWin..LTV_Member_Lifetime_ID			as a 
join pdb_WalkandWin..LTV_Member_Month					as x	on a.SavvyHICN = x.SavvyHICN and a.Disenroll_Year_Mo = x.Year_Mo
left join #trr_disenrollment				as c	on a.SavvyHICN = c.SavvyHICN and a.Disenroll_Year_Mo = c.Year_Mo
left join MiniOV..SavvyID_to_SavvyHICN		as d	on a.SavvyHICN = d.SavvyHICN
left join MiniOV..Dim_Member				as e	on d.SavvyID = e.SavvyID
-- 50901

create unique index ix_x on pdb_WalkandWin..LTV_Member_Disenrollment(SavvyHICN, Lifetime_ID)
create unique index ix_y on pdb_WalkandWin..LTV_Member_Disenrollment(SavvyHICN, Disenroll_Year_Mo)
