...
into #mapd
from pdb_WalkandWin..WnW_Dataset_Sam_MMR
...
select a.SavvyHICN, a.Lifetime_ID, a.Year_Mo, a.Contr_Nbr, a.PBP,
	   ...
	   a.Top5_Prcnt_2015,
	   a.Top5_Prcnt_2016
into pdb_WalkandWin..LTV_Member_Month_2016_Pilot
from #results_2						as a
join pdb_WalkandWin..CPI_Adjustment			as b	on left(a.Year_Mo, 4) = b.Yr
-- 2,400,108


create unique clustered index ix_x on pdb_WalkandWin..LTV_Member_Month_2016_Pilot(SavvyHICN, Year_Mo)
