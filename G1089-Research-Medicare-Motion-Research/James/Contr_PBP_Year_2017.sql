...
into #contr
from pdb_WalkandWin..LTV_Member_Month
...
--1102
-- drop table pdb_WalkandWin..Contr_PBP_Year
...
into pdb_WalkandWin..Contr_PBP_Year
from #contr			as a 
...
create unique index ix_contr_pbp_yr on pdb_WalkandWin..Contr_PBP_Year(Contr_Nbr, PBP, Plan_Year)