...
-- drop table pdb_WalkandWin..LTV_Member_Lifetime_ID_2016_Pilot
...
into pdb_WalkandWin..LTV_Member_Lifetime_ID_2016_Pilot
from pdb_WalkandWin..LTV_Member_Month_2016_Pilot               as a
group by SavvyHICN, Lifetime_ID
-- 50,901

select * from pdb_WalkandWin..LTV_Member_Lifetime_ID_2016_Pilot
