...
join pdb_WalkandWin..LTV_Member_Enrollment_2016_Pilot					as c	on a.SavvyHICN = c.SavvyHICN
...
join pdb_WalkandWin..LTV_Member_Enrollment_2016_Pilot					as d	on c.SavvyHICN = d.SavvyHICN
...
from pdb_WalkandWin..LTV_Member_Enrollment_2016_Pilot	as a 
...
-------------------------------------------------------------
-- drop table pdb_WalkandWin..LTV_Member_Lifetime_2016_Pilot
select a.*, 
...
into pdb_WalkandWin..LTV_Member_Lifetime_2016_Pilot
from(
...
create unique index ix_SH_LI on pdb_WalkandWin..LTV_Member_Lifetime_2016_Pilot(SavvyHICN, Lifetime_ID)
create unique index ix_SH_EY on pdb_WalkandWin..LTV_Member_Lifetime_2016_Pilot(SavvyHICN, Enroll_Year_Mo)
create unique index ix_SH_DY on pdb_WalkandWin..LTV_Member_Lifetime_2016_Pilot(SavvyHICN, Disenroll_Year_Mo)
